...
async function fetchArtwork() {
  try {
    const response = await fetch(
      "https://api.artic.edu/api/v1/artworks/search?query[term][is_public_domain]=true&limit=10&fields=title,date_display,artist_title,medium_display,dimensions,is_public_domain,image_id",
    );
    if (!response.ok) {
